...
knitr::include_graphics(path = "../images//languages.png", auto_pdf = TRUE)
``` 
...
## Python
```{r, fig.align = 'center',out.width= '20%', echo=FALSE }
knitr::include_graphics(path = "../images//python.png", auto_pdf = TRUE)
``` 
...
## Perl
```{r, fig.align = 'center',out.width= '20%', echo=FALSE }
knitr::include_graphics(path = "../images//perl.png", auto_pdf = TRUE)
``` 
...
## Ruby
```{r, fig.align = 'center',out.width= '20%', echo=FALSE }
knitr::include_graphics(path = "../images//ruby.png", auto_pdf = TRUE)
``` 
...
## Golang (AKA Go)
```{r, fig.align = 'center',out.width= '20%', echo=FALSE }
knitr::include_graphics(path = "../images//golang.png", auto_pdf = TRUE)
``` 
...
## R
```{r, fig.align = 'center',out.width= '20%', echo=FALSE }
knitr::include_graphics(path = "../images//R.png", auto_pdf = TRUE)
``` 
