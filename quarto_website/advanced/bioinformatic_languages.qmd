...
![](/images/languages.png){style="width:200px; background: white; border-radius:5px" fig-align="center"}
...
## Python
![](/images/python.png){style="width:200px; border-radius:15px; background:white" fig-align="center"}
...
## Perl
![](/images/perl.png){style="width:200px; border-radius:15px; background:null" fig-align="center"}

Perl is a similar language to python with similar uses. The main difference is how they look.

Tutorial:

[https://www.tutorialspoint.com/perl/perl_introduction.htm](https://www.tutorialspoint.com/perl/perl_introduction.htm)
...
## R
![](/images/R.png){style="width:200px; border-radius:15px; border:5px solid white; background:white" fig-align="center"}
