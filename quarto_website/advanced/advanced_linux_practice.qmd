...
knitr::include_graphics(path = "../images//linux_intermdiary.png", auto_pdf = TRUE)
```
...
```{r, fig.align = 'center',out.width= '20%', echo=FALSE }
knitr::include_graphics(path = "../images//wildcard.png", auto_pdf = TRUE)
```
...
knitr::include_graphics(path = "../images//chevron.png", auto_pdf = TRUE)
```
...
```{r, fig.align = 'center',out.width= '20%', echo=FALSE }
knitr::include_graphics(path = "../images//pipes.png", auto_pdf = TRUE)
```
...
```{r, fig.align = 'center',out.width= '20%', echo=FALSE }
knitr::include_graphics(path = "../images//trex.png", auto_pdf = TRUE)
```
...
```{r, fig.align = 'center',out.width= '20%', echo=FALSE }
knitr::include_graphics(path = "../images//sed.png", auto_pdf = TRUE)
```
...
```{r, fig.align = 'center',out.width= '20%', echo=FALSE }
knitr::include_graphics(path = "../images//question_bubble_red.png", auto_pdf = TRUE)
```
