...
![](/images/files.png){style="width:200px; background:white; border-radius:5px" fig-align="center"}

There are many ways to show the contents of a file. Below are a few examples. 

The files for the examples are within the directory:  __"/pub14/tea/nsc2xx/Linux/5_reading_files/"__.

::: {.callout-important}
Remember to change **nsc2xx** to your specific user name as shown on the command line prompt.
:::
...
## Print out a file
![](/images/cat.png){style="width:200px; background: white; border-radius:5px" fig-align="center"}
...
## head and tail
![](/images/head_and_tails.png){style="width:300px; border-radius:15px; background:white" fig-align="center"}
...
![](/images/less.png){style="width:200px; border-radius:15px; background:white" fig-align="center"}
...
## Word count
![](/images/wc.png){style="width:200px; border-radius:15px; background:white" fig-align="center"}
...
## Pattern searching
![](/images/pattern.png){style="width:200px; border-radius:15px; background:white" fig-align="center"}
...
## Text editor
![](/images/text_editor.png){style="width:200px; border-radius:15px; background:white" fig-align="center"}
...
### nano
![](/images/1200px-Gnu-nano.png){style="width:200px; border-radius:15px; background:white" fig-align="center"}
...
::: {.callout-important}
__Ctrl+W__ is a browser shortcut to close tabs. Therefore it can't be used within our webVNC to start a search in `nano`. It should work in you own future use linux.
:::
...
![](/images/question_bubble_purple.png){style="width:150px" fig-align="center"}
