...
knitr::include_graphics(path = "../images//files.png", auto_pdf = TRUE)
```
...
```{r, fig.align = 'center',out.width= '20%', echo=FALSE }
knitr::include_graphics(path = "../images//cat.png", auto_pdf = TRUE)
```
...
knitr::include_graphics(path = "../images//head_and_tails.png", auto_pdf = TRUE)
```
...
```{r, fig.align = 'center',out.width= '20%', echo=FALSE }
knitr::include_graphics(path = "../images//less.png", auto_pdf = TRUE)
```
...
```{r, fig.align = 'center',out.width= '20%', echo=FALSE }
knitr::include_graphics(path = "../images//wc.png", auto_pdf = TRUE)
```
...
```{r, fig.align = 'center',out.width= '20%', echo=FALSE }
knitr::include_graphics(path = "../images//pattern.png", auto_pdf = TRUE)
```
...
```{r, fig.align = 'center',out.width= '20%', echo=FALSE }
knitr::include_graphics(path = "../images//text_editor.png", auto_pdf = TRUE)
```
...
```{r, fig.align = 'center',out.width= '20%', echo=FALSE }
knitr::include_graphics(path = "../images//1200px-Gnu-nano.png", auto_pdf = TRUE)
```
...
```{r, fig.align = 'center',out.width= '20%', echo=FALSE }
knitr::include_graphics(path = "../images//question_bubble_purple.png", auto_pdf = TRUE)
```
