...
knitr::include_graphics(path = "../images//windows.png", auto_pdf = TRUE)
```
...
```{r, fig.align = 'center',out.width= '15%', echo=FALSE }
knitr::include_graphics(path = "../images//turtle_shell.png", auto_pdf = TRUE)
```
...
```{r, fig.align = 'center',out.width= '15%', echo=FALSE }
knitr::include_graphics(path = "../images//file_transfer.png", auto_pdf = TRUE)
```
