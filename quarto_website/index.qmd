...
knitr::include_graphics(path = "./images/NEOF.png", auto_pdf = TRUE)
```

# Introduction {#intro}

```{r, fig.align = 'center',out.width= '20%', echo=FALSE }
knitr::include_graphics(path = "./images/linux_beginner.png", auto_pdf = TRUE)
```
...
|                                                                     |                                                                  |
| [![](./images/linux_beginner.png){width="142"}](#linuxintro)         | [![](./images/start.png){width="189"}](#cluster)                  |
+---------------------------------------------------------------------+------------------------------------------------------------------+
| [**Directories and files**](#dirsandfiles)                          | [**Tips and tricks**](#tipsandtricks)                            |
|                                                                     |                                                                  |
| [![](./images/directory.png){width="125"}](#dirsandfiles)            | [![](./images/skateboard_trick.png){width="302"}](#tipsandtricks) |
+---------------------------------------------------------------------+------------------------------------------------------------------+
| [**Manipulating Directories**](#manipulatingdirectories)            | [**File reading and processing**](#filereadingandprocessing)     |
|                                                                     |                                                                  |
| [![](./images/transform.png){width="150"}](#manipulatingdirectories) | [![](./images/files.png){width="205"}](#filereadingandprocessing) |
+---------------------------------------------------------------------+------------------------------------------------------------------+
| [**Advanced Linux**](#advancedlinux)                                | [**Other Bioinformatics programming languages**](#bfxlanguages)  |
|                                                                     |                                                                  |
| [![](./images/linux_intermdiary.png){width="142"}](#advancedlinux)   | [![](./images/languages.png){width="159"}](#bfxlanguages)         |
+---------------------------------------------------------------------+------------------------------------------------------------------+
| [**Appendix**](#cheatsheet)                                         |                                                                  |
|                                                                     |                                                                  |
| [![](./images/cheatsheet.png){width="150"}](#cheatsheet)             |                                                                  |
+---------------------------------------------------------------------+------------------------------------------------------------------+
