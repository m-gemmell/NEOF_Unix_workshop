...
knitr::include_graphics(path = "../images//transform.png", auto_pdf = TRUE)
``` 
...
```{r, fig.align = 'center',out.width= '20%', echo=FALSE }
knitr::include_graphics(path = "../images//chicken.png", auto_pdf = TRUE)
```
...
```{r, fig.align = 'center',out.width= '20%', echo=FALSE }
knitr::include_graphics(path = "../images//copy.png", auto_pdf = TRUE)
```
...
```{r, fig.align = 'center',out.width= '20%', echo=FALSE }
knitr::include_graphics(path = "../images//erase.png", auto_pdf = TRUE)
```
...
```{r, fig.align = 'center',out.width= '20%', echo=FALSE }
knitr::include_graphics(path = "../images//question_bubble_green.png", auto_pdf = TRUE)
```
