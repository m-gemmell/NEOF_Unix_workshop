...
![](/images/transform.png){style="width:200px; border-radius:15px; background:white" fig-align="center"}
...
![](/images/chicken.png){style="width:150px; background:white; border-radius:5px; border: white solid 5px" fig-align="center"}
...
![](/images/copy.png){style="width:150px; background:white; border-radius:5px; border: 5px solid white" fig-align="center"}
...
![](/images/erase.png){style="width:200px; border-radius:15px; background:white" fig-align="center"}
...
![](/images/question_bubble_green.png){style="width:150px" fig-align="center"}
