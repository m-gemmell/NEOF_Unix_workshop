# Starting
![](/images/start.png){style="width:200px; background:white; border-radius:5px" fig-align="center"}
...
![](/images/nsc200_logon.png){style="width:800px; border-radius:5px; border: #282828 solid 5px" fig-align="center"}
...
![](/images/terminal_window.png){style="width:700px; border:radius:5px" fig-align="center"}
...
![](/images/enter_symbol.png){style="width:200px; border-radius:15px; background:white" fig-align="center"}
...
::: {.callout-note}
The `man` page acts like using the command **less** (we will get into more specifics later). Important notes for now are to use the **arrow keys** to go **up** and **down** the page and press `q` to exit the manual.
:::
...
::: {.callout-note}
There is a [cheat sheet](/appendix/cheat_sheet.qmd) at the end of this document with all the commands covered in this practical.
:::
