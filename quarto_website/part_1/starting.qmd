...
knitr::include_graphics(path = "../images//start.png", auto_pdf = TRUE)
```
...
knitr::include_graphics(path = "../images//logon_pic.png", auto_pdf = TRUE)
```
...
```{r, fig.align = 'center',out.width= '80%', echo=FALSE }
knitr::include_graphics(path = "../images//terminal_window.png", auto_pdf = TRUE)
```
...
```{r, fig.align = 'center',out.width= '20%', echo=FALSE }
knitr::include_graphics(path = "../images//enter_symbol.png", auto_pdf = TRUE)
```
