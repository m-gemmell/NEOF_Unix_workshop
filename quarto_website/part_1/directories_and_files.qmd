...
![](/images/directory.png){style="width:150px; background:white; border-radius:5px" fig-align="center"}

`r hide("Optional video walk-through")`
<div class="container">
...
![](/images/data_files.png){style="width:150px; background: white; border-radius:5px" fig-align="center"}
...
![](/images/cd.png){style="width:200px; background: white; border-radius:5px" fig-align="center"}
...
### Copying
![](/images/copy_vaporwave.png){style="width:200px; background: white; border-radius:5px; border: 5px white solid" fig-align="center"}
...
![](/images/linux_tree_structure.png){style="width:600px; border-radius:15px" fig-align="center"}
...
![](/images/linux_box_structure.png){style="width:400px; border-radius:15px" fig-align="center"}

## Paths
![](/images/paths.png){style="width:200px; background: white; border-radius:5px" fig-align="center"}
...
::: {.callout-important}
When typing the code you must change **nsc2xx** to your specific user name as shown on the command line prompt.
:::
...
![](/images/List.png){style="width:200px; background: white; border-radius:15px" fig-align="center"}
...
![](/images/question_bubble.png){style="width:150px" fig-align="center"}
