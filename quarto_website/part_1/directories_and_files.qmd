...
knitr::include_graphics(path = "../images/directory.png", auto_pdf = TRUE)
```
...
knitr::include_graphics(path = "../images//linux_tree_structure.png", auto_pdf = TRUE)
```
...
knitr::include_graphics(path = "../images//linux_box_structure.png", auto_pdf = TRUE)
```

## Paths

```{r, fig.align = 'center',out.width= '20%', echo=FALSE }
knitr::include_graphics(path = "../images//paths.png", auto_pdf = TRUE)
```
...
```{r, fig.align = 'center',out.width= '20%', echo=FALSE }
knitr::include_graphics(path = "../images//List.png", auto_pdf = TRUE)
```
...
```{r, fig.align = 'center',out.width= '20%', echo=FALSE }
knitr::include_graphics(path = "../images//question_bubble.png", auto_pdf = TRUE)
```
