...
![](/images/skateboard_trick.png){style="width:200px; background: white; border-radius:5px" fig-align="center"}
...
![](/images/tab_complete.png){style="width:150px; border-radius:5px; border:5px solid white; background:white" fig-align="center"}
...
```{bash eval=FALSE}
cd /pub14/tea/n<tab>2xx<tab>L<tab>1_d<tab>
``` 
...
## Ending a command
![](/images/ctrl_c.png){style="width:300px; ; border-radius:5px; border:2px solid white; background:white" fig-align="center"}
...
## History
![](/images/history.png){style="width:150px; border-radius:5px; background:white" fig-align="center"}
...
## Clear
![](/images/clean.png){style="width:150px; background: white; border-radius:5px" fig-align="center"}
...
## Annotations
![](/images/hashtag.png){style="width:150px; border-radius:15px; background:white" fig-align="center"}
...
## MCQs: Tips & tricks
![](/images/question_bubble_blue.png){style="width:150px" fig-align="center"}
