...
knitr::include_graphics(path = "../images//skateboard_trick.png", auto_pdf = TRUE)
``` 
...
knitr::include_graphics(path = "../images//tab_complete.png", auto_pdf = TRUE)
``` 
...
## History
```{r, fig.align = 'center',out.width= '15%', echo=FALSE }
knitr::include_graphics(path = "../images//history.png", auto_pdf = TRUE)
``` 
...
## Annotations
```{r, fig.align = 'center',out.width= '15%', echo=FALSE }
knitr::include_graphics(path = "../images//hashtag.png", auto_pdf = TRUE)
``` 
...
knitr::include_graphics(path = "../images//question_bubble_blue.png", auto_pdf = TRUE)
```
